...
This guide is a translation of [Sam Newberry's achievement guide in Russian](https://steamcommunity.com/sharedfiles/filedetails/?id=2038447122). I added several screenshots to the translation for the **Knowledge is power** achievement. In order to avoid clutter in this page as this achievement spans several different maps, I will create a separate page with information regarding the **Pet zoo** achievement.

Furthermore, the answers for the **Reading is radical** achievements will be provided in this translation. A separate subsection will be dedicated to providing references for the answers to the questions.

WARNING: The following content contains many spoilers for the game.

# Story Achievements

<img src="{{site.baseurl}}/images/achievement_guide/stubs/so_you_want_to_be_a_hero.jpg" width="64px" height="64px"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;**So you want to be a hero**

Complete the training task at the beginning of the game (Diana's exam in the Thieves Guild)

<img src="{{site.baseurl}}/images/achievement_guide/stubs/magical_girl.jpg" width="64px" height="64px"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;**Magical Girl**

Awarded for completing Felicia's quest. Fulfill all the requirements of the Strizhinsky wizard Severin.

<img src="{{site.baseurl}}/images/achievement_guide/stubs/no_honor_among_thieves.jpg" width="64px" height="64px"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;**No honor among thieves**
...
<img src="{{site.baseurl}}/images/achievement_guide/stubs/follow_the_light.jpg" width="64px" height="64px"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;**Follow the light**

Awarded for completing Svetlana's first quest involving the holy relics in Sableby.

<img src="{{site.baseurl}}/images/achievement_guide/stubs/come_to_the_dark_side.jpg" width="64px" height="64px"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;**Come to the dark side**
...
<img src="{{site.baseurl}}/images/achievement_guide/stubs/boot_camp.jpg" width="64px" height="64px"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;**Boot camp**

Awarded for completing Anastasia's quest involving entry into the Guild of Warriors.

<img src="{{site.baseurl}}/images/achievement_guide/stubs/antiheroines.jpg" width="64px" height="64px"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;**Antiheroines**

Beat the goblin adventure party in Four Peaks in the final part of the game.

<img src="{{site.baseurl}}/images/achievement_guide/stubs/conquering_fear.jpg" width="64px" height="64px"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;**Conquering fear**

Complete the first (and currently only) act of the game.

# Boss Achievements

<img src="{{site.baseurl}}/images/achievement_guide/stubs/heros_labours.jpg" width="64px" height="64px"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;**Hero’s labors**
...
<img src="{{site.baseurl}}/images/achievement_guide/stubs/annoying_bees.jpg" width="64px" height="64px"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;**Annoying bees**
...
<img src="{{site.baseurl}}/images/achievement_guide/stubs/a_matter_of_size.jpg" width="64px" height="64px"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;**A matter of size**
...
<img src="{{site.baseurl}}/images/achievement_guide/stubs/woeful_soul.jpg" width="64px" height="64px"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;**Woeful soul**
...
<img src="{{site.baseurl}}/images/achievement_guide/stubs/swamp_hag.jpg" width="64px" height="64px"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;**Swamp hag**
...
<img src="{{site.baseurl}}/images/achievement_guide/stubs/there_prowls_a_sprite.jpg" width="64px" height="64px"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;**There prowls a sprite ...**
...
<img src="{{site.baseurl}}/images/achievement_guide/stubs/glory_in_battle.jpg" width="64px" height="64px"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;**Glory in battle!**
...
<img src="{{site.baseurl}}/images/achievement_guide/stubs/train_hard.jpg" width="64px" height="64px"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;**Train hard ...**
...
<img src="{{site.baseurl}}/images/achievement_guide/stubs/earth_amulet.jpg" width="64px" height="64px"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;**Earth Amulet**
...
<img src="{{site.baseurl}}/images/achievement_guide/stubs/soldiers_spirit.jpg" width="64px" height="64px"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;**Soldier's spirit**
...
<img src="{{site.baseurl}}/images/achievement_guide/stubs/star_guardian.jpg" width="64px" height="64px"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;**Star Guardian**
...
<img src="{{site.baseurl}}/images/achievement_guide/stubs/original_prankster.jpg" width="64px" height="64px"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;**Original prankster**
...
<img src="{{site.baseurl}}/images/achievement_guide/stubs/gods_will_hear_thee.jpg" width="64px" height="64px"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;**Gods will hear thee**
...
<img src="{{site.baseurl}}/images/achievement_guide/stubs/scrooge.jpg" width="64px" height="64px"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;**Scrooge**
...
<img src="{{site.baseurl}}/images/achievement_guide/stubs/30_30_vision.jpg" width="64px" height="64px"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;**30/30 vision**
...
<img src="{{site.baseurl}}/images/achievement_guide/stubs/toss_a_coin_to_your_watchman.jpg" width="64px" height="64px"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;**Toss a coin to your watchman**
...
<img src="{{site.baseurl}}/images/achievement_guide/stubs/pet_zoo.jpg" width="64px" height="64px"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;**Pet zoo**
...
<img src="{{site.baseurl}}/images/achievement_guide/stubs/fight_another_day.jpg" width="64px" height="64px"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;**Fight another day**
...
<img src="{{site.baseurl}}/images/achievement_guide/stubs/cleanliness_is_godliness.jpg" width="64px" height="64px"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;**Cleanliness is godliness**
...
<img src="{{site.baseurl}}/images/achievement_guide/stubs/hero_fisherman.jpg" width="64px" height="64px"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;**Hero fisherman**

After Anastasia enters the Warriors Guild, fight in the arena with monsters twice. Then try to request another battle with the monsters - the captain will answer that they haven’t brought a new one yet. Now, if you go to the global map, a random (in fact, scripted) meeting will be waiting for you. A trinity of mercenaries are escorting a giant slug into the Guild (this is that new monster). The mercenary commander will ask you for a loan of 2000 coins - agree. It’s impossible to return to this map again, so if you do not have the right amount of cash with you at that time, you will have to get the achievement in another way! After giving the money, leave the venue, and then return to the Warriors Guild. The monster is delivered. Talk to the mercenaries - they, alas, they will not be able to return the money, but as a compensation they will give a silver watermelon. If you refused to lend them or you simply didn’t have money at the time of the first meeting, you can find a watermelon in the basement of one of the houses in Zarechye (for this Diana must have maximum perception by obtaining all the gifts of the Laverna - see the achievement **30/30 vision**). After that, head to the Star Cave and in its southeastern part you will find a dude who catches fish. Talk to him - you will find out that he needs a silver watermelon as bait. What a lucky coincidence, right? Give him the watermelon and get the achievement.

<img src="{{site.baseurl}}/images/achievement_guide/stubs/citys_little_helpers.jpg" width="64px" height="64px"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;**City's little helpers**

You must complete two quests in Strizhinsk - you need to find the villain that supplies schoolchildren with alcohol and help fix the city bath. They are obtained sequentially. An angry woman at the door of the Old Mug tavern issues a quest for drinking minors. After completing that quest, talk to the chief secretary  in the prefecture. He will instruct you to deal with the delays in repairing the bath. When you do this, you will receive an achievement.

<img src="{{site.baseurl}}/images/achievement_guide/stubs/goodie_two_shoes.jpg" width="64px" height="64px"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;**Goodie two-shoes**

After defeating the minotaur in the Sableby dungeon (see the **Hero’s labors** achievement), a door leading north will appear in the basement of the church. Behind it is a small room with a statue of a bright goddess, in front of which there is a plate on a pedestal. On the plate lies the legendary Forbidden Fruit, but only those who are truly pure in soul can see it. Donate 1,500 coins in the Stryzhinsky Convent (see the **Gods will hear thee** achievement), and also complete the quest to eliminate kikimora without killing it (see the **Swamp hag** achievement). Find Tucker in a tavern in Roadside, and return his dagger to him that you took at the beginning of the game. If you behaved badly, you can atone for sins by increasing the size of the donation in the monastery - very bad girls should get ready to lay out 10 thousand coins, and possibly more. After that, you will be able to pick up the fruit and get the achievement.

<img src="{{site.baseurl}}/images/achievement_guide/stubs/reading_is_radical.jpg" width="64px" height="64px"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;**Reading is radical**
...
<img src="{{site.baseurl}}/images/achievement_guide/stubs/learn_to_count.jpg" width="64px" height="64px"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;**Learn to count**

You can get the achievement in Strizhinsk or Sableby. In the first case, this is done at the very beginning of the game. When you need to enter the city sewer, the heroines have the option of just jumping into the well. In the second case, the opportunity appears when completing the Svetlana's first quest. After learning that an underground passage can lead to the Sableby church, talk about it with the locals and the wells (there are two of them in the village) will become accessible for diving. Normally you need 4 water breathing potions (one for each of the heroines), and in the case of Sableby also a rope. In order to earn this achievement, make sure that you have from 1 to 3 potions in stock and try to climb into the well.

<img src="{{site.baseurl}}/images/achievement_guide/stubs/papers_please.jpg" width="64px" height="64px"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;**Papers, please!**

If you have already tried to bypass the main gate of Strizhinsk, you will learn that the main entrance has a 100 coin toll. Furthermore, if you talked with the residents of Sawdust on this topic, it will be possible to ask the tax inspector about the option of free passage. The tax inspector is located on the second floor of the Strizhinsk prefecture via the eastern stairs. In order to earn the achievement, you have to fork out a lot of coins and run from the prefecture to the gate and back several times. Once all the bureaucratic obstacles are overcome, you will receive an achievement, and the ability to walk through the gate for free. WARNING: After this, completing the **Toss a coin to your watchman**  achievement will become unavailable, so it makes sense to complete it before getting free passage.

<img src="{{site.baseurl}}/images/achievement_guide/stubs/power_of_word.jpg" width="64px" height="64px"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;**Power of word**

In the goblin cave at Four Peaks, go south, then east. You will see a company of four goblins sitting by the fire next to a rope that allows you to go down. There is an marker you can interact with near the stone. Upon activating the interaction, the heroines will decide that you can clear the way without a fight by throwing a note to the goblins. Agree to write it, and select the text and signature (you want to promise great love and sign the note as the “Green Furies”). After tossing the note, the goblins happily run away looking for amorous adventuress, and you get this achievement.

<img src="{{site.baseurl}}/images/achievement_guide/stubs/steal_what_was_stolen.jpg" width="64px" height="64px"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;**Steal what was stolen**

At the very beginning of the game, when completing the training task, after you find the 4 gifts of the Laverna in the dungeon, do not rush to carry them to the statue of the goddess. Instead, climb to the floor above, where the first stage of the exam was held, and Diana will notice a secret door there. Enter and observe the event scene, then return to the dungeon to complete the exam. Later, when you collect the party, look in the Sawdust Tavern, and the quest giver will be there.